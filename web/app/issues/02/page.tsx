...
export default function IssueTwo(){return <article className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-14">
 ...
 <div className="grid lg:grid-cols-[1.7fr_1fr] gap-12 lg:gap-20 mt-12">
  <div className="font-serif text-lg leading-[1.85] text-ink-soft space-y-7">
   ...
   <div className="flex gap-3 flex-wrap border-t border-rule pt-7"><Link className="pill" prefetch={false} href="/song/justin-bieber/beauty-and-a-beat">Explore the returning hit →</Link><Link className="pill pill-ghost" prefetch={false} href="/song">Read another song →</Link></div>
  </div>
