...
export const metadata: Metadata = {
  title: "Issue 01 · The Monsters of Sarajevo",
  description: "Jala Brat, Buba Corelli, and the dictionary inside GODZILLA. The original LyricStats feature.",
  alternates: { canonical: "/issues/01" },
  openGraph: { title: "Issue 01 · The Monsters of Sarajevo", description: "Jala Brat, Buba Corelli, and the dictionary inside GODZILLA.", url: "/issues/01", type: "article" },
};
import { SITE_URL } from "@/lib/site";

/**
 * Archived Issue 01, cover to cover. No mission-statement hero; the
...
const articleData = {
  ...
  mainEntityOfPage: `${SITE_URL}/issues/01`,
};
    ...
    <article className="mx-auto max-w-6xl px-4 sm:px-6 pt-8 sm:pt-12 pb-16 sm:pb-20">
      ...
      <header className="rise rise-1 border-b-4 border-double border-rule-strong pb-8 sm:pb-10">
        <div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1">
          ...
          <p className="smallcaps">9 June 2026 · Sarajevo</p>
        </div>
      ...
      <section className="mt-10 sm:mt-14 grid gap-12 lg:grid-cols-[2fr_1fr] lg:gap-16">
        ...
        <aside className="rise rise-3 space-y-8 lg:mt-2">
          ...
          <div className="border border-rule-strong p-6 space-y-4">
            <h4 className="display text-xl text-ink">The hit that wouldn’t stay in 2012</h4>
            <p className="font-serif text-sm text-ink-soft leading-relaxed">
              Beauty and a Beat, pop’s second lives, and the songs that find another summer.
            </p>
            <Link href="/issues/02" className="smallcaps text-accent hover:underline">Read Issue 02 →</Link>
          </div>
        </aside>
      </section>
    </article>
